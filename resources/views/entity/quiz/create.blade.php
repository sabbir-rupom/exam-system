...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('pageTitle') New Quiz @endslot
    @endcomponent
        ...
        <div class="card-body">
            ...
            <form action="{{ route('quizzes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" max="200" class="form-control" id="input--duration" required
                                placeholder="enter a number" value="{{ old('duration', '') }}" name="duration">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" max="100" class="form-control" id="input--pass_mark" required
                                placeholder="enter a number" value="{{ old('pass_mark', 0) }}" name="pass_mark">
                    ...
                    <div class="col-md-3">
                        <div class="d-inline-flex mt-4">
                            <div class="form-check pt-3">
                                <input class="form-check-input" type="checkbox" id="input--status" value="1" name="status" checked="">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select select2" id="select--questions" name="questions[]" multiple
